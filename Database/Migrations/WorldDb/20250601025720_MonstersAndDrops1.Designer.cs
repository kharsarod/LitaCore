...
namespace Database.Migrations.WorldDb
{
    ...
    [Migration("20250601025720_MonstersAndDrops1")]
    partial class MonstersAndDrops1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Database.MonsterData.NpcMonsterSkill", b =>
                {
                    b.Property<long>("NpcMonsterSkillId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasColumnName("npcmonsterskillid");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<long>("NpcMonsterSkillId"));
